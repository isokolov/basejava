...
public class ResumeTestData {
    ...
    private static List<Resume> resumes = new ArrayList<Resume>();
    ...
    static
    {
        ...
        //org1.getPositionEntries().add(org1.new PositionEntry(LocalDate.of(2013, Month.MARCH, 1), LocalDate.of(2013, Month.MAY, 1), ""));
